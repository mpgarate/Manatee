...
//        mSystemUiHider.setOnVisibilityChangeListener(new SystemUiHider
...
//                    }
//                    if (mShortAnimTime == 0) {
//                        mShortAnimTime = getResources().getInteger(android.R
...
//                    // controls.
//                    controlsView.setVisibility(visible ? View.VISIBLE : View
//                            .GONE);
//                }
//
...
//        });
        ...
        findViewById(R.id.dummy_button).setOnClickListener(buttonClickListener);
    ...
    View.OnTouchListener mDelayHideTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            LOGGER.info("on touch! : " + motionEvent);
            if (AUTO_HIDE) {
                delayedHide(AUTO_HIDE_DELAY_MILLIS);
            }
            return false;
